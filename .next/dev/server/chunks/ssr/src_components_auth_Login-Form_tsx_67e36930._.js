...
function LoginForm() {
    ...
    async function onSubmit(e) {
        ...
        const rawResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"].email({
            email,
            password,
            callbackURL,
            rememberMe: true
    ...
    async function handleGoogleSignup() {
        setError(null);
        const rawResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"].social({
            provider: 'google',
            callbackURL: '/'
        });
        const result = rawResult;
...
//# sourceMappingURL=src_components_auth_Login-Form_tsx_67e36930._.js.map